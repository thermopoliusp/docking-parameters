...
do
	rm -rf $top/GROMACS/water_model_effect/gro_correction_and_charges/$dir
	mkdir -p $top/GROMACS/water_model_effect/gro_correction_and_charges/$dir
	cp $top/GROMACS/water_model_effect/{,gro_correction_and_charges/}$dir/md_2_0.gro
	cp $top/GROMACS/water_model_effect/{,gro_correction_and_charges/}$dir/$(echo $dir | \
		tr '[a-z]' '[A-Z]')_original.pdb
	cd $top/GROMACS/water_model_effect/gro_correction_and_charges/$dir
