...
do
	rm -rf $top/GROMACS/gro_correction_and_charges_npt/$dir
	mkdir -p $top/GROMACS/gro_correction_and_charges_npt/$dir
	cp $top/GROMACS/{,gro_correction_and_charges_npt/}$dir/npt.gro
	cp $top/GROMACS/{,gro_correction_and_charges_npt/}$dir/$(echo $dir | \
		tr '[a-z]' '[A-Z]')_original.pdb
	cd $top/GROMACS/gro_correction_and_charges_npt/$dir
