...
do
	rm -rf $top/GROMACS/gro_correction_and_charges_em/$dir
	mkdir -p $top/GROMACS/gro_correction_and_charges_em/$dir
	cp $top/GROMACS/{,gro_correction_and_charges_em/}$dir/em.gro
	cp $top/GROMACS/{,gro_correction_and_charges_em/}$dir/$(echo $dir | \
		tr '[a-z]' '[A-Z]')_original.pdb
	cd $top/GROMACS/gro_correction_and_charges_em/$dir
