...
do
	rm -rf $top/GROMACS/gro_correction_and_charges_nvt/$dir
	mkdir -p $top/GROMACS/gro_correction_and_charges_nvt/$dir
	cp $top/GROMACS/{,gro_correction_and_charges_nvt/}$dir/nvt.gro
	cp $top/GROMACS/{,gro_correction_and_charges_nvt/}$dir/$(echo $dir | \
		tr '[a-z]' '[A-Z]')_original.pdb
	cd $top/GROMACS/gro_correction_and_charges_nvt/$dir
